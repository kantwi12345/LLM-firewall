  ...
  return (
    <div className="two-col">
      <div className="card">
        ...
        <pre style={{ background: 'var(--bg)', padding: 8, borderRadius: 6, whiteSpace: 'pre-wrap' }}>
        ...
        {challengeResult && (
          <p style={{ marginTop: 12 }}>
            {challengeResult.classification === 'safe'
              ...
              : `Caught — Classified as ${challengeResult.classification} (score ${challengeResult.threat_score.toFixed(2)}).`}
          </p>
        )}
